...
int i = 1,x;
ShowMessage("Вы набираете номер: "+call.mess+"\nПереведите ваш телефон в тональный режим и поднесите к динамику устройства.\nЗатем нажмите кнопку ОК.");
  while(i<=call.mess.Length()){
        ...
        switch(x){
           ...
           default: {
           throw My_call_exception("Ошибка!\nНеправильно набран номер!\nНедопустимый для набора символ: ", call.mess[i-1]);
           //break;
           }
        }
  }
