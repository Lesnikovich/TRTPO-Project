...
void __fastcall TfEditor::DBEdit1KeyPress(TObject *Sender, char &Key)
{
...
void __fastcall TfEditor::DBEdit2KeyPress(TObject *Sender, char &Key)
{
...
void __fastcall TfEditor::DBEdit3KeyPress(TObject *Sender, char &Key)
{
...
void __fastcall TfEditor::DBEdit4KeyPress(TObject *Sender, char &Key)
{
...
void __fastcall TfEditor::DBEdit5KeyPress(TObject *Sender, char &Key)
{
...
void __fastcall TfEditor::DBEdit6KeyPress(TObject *Sender, char &Key)
{
...
void __fastcall TfEditor::DBEdit7KeyPress(TObject *Sender, char &Key)
{
        DBEdit7->MaxLength = 4;
...
void __fastcall TfEditor::DBEdit8KeyPress(TObject *Sender, char &Key)
{
        DBEdit8->MaxLength = 1;
...
void __fastcall TfEditor::DBEdit9KeyPress(TObject *Sender, char &Key)
{
        DBEdit9->MaxLength = 4;
...
void __fastcall TfEditor::DBEdit10KeyPress(TObject *Sender, char &Key)
{
...
void __fastcall TfEditor::DBEdit11KeyPress(TObject *Sender, char &Key)
{
...
void __fastcall TfEditor::DBEdit12KeyPress(TObject *Sender, char &Key)
{
...
void __fastcall TfEditor::DBEdit13KeyPress(TObject *Sender, char &Key)
{
